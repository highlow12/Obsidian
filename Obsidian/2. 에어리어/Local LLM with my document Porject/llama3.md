Llama3는 메타에서 2024년 4월 17일에 공개한 최신 대규모 언어 모델. 기존 Llama2 모델 대비 성능이 크게 향상되었으며, 다양한 자연어 처리 태스크에서 우수한 성능을 보여줌. 공개된 모델은 80억 개 매개변수를 가진 8B 모델과 700억 개 매개변수를 가진 70B 모델 두 가지. 400B 모델도 훈련 중.
