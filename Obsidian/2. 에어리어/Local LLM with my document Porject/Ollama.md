Ollama는 오픈소스 [[LLM|Large Language Model (LLM)]]을 로컬 PC에서 쉽게 실행할 수 있게 해주는 도구이다. Mistral, Llama 3 등 다양한 오픈소스 [[LLM]]을 지원하며, 모델 가중치, 설정, 데이터셋을 하나의 패키지로 묶어서 Modelfile로 관리합니다.
