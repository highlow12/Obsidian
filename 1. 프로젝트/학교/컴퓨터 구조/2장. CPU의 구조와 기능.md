...
>     participant Output
> 
>     User ->> Stage1: Send Initial Input
>     Stage1 ->> Stage1: Parse Input
>     Stage1 ->> Stage1: Preprocess Data
>     Stage1 ->> Stage2: Forward Preprocessed Data
> 
>     Stage2 ->> Stage2: Process Data
>     Stage2 ->> Stage2: Apply Specific Rules
>     Stage2 ->> Output: Generate Final Output
> 
>     Output ->> User: Return Final Output
>```
